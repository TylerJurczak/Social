...
<head>
  ...
  <title>Installer (v<?php echo SYS_VER ?>)</title>
      ...
      <form id="wizard" method="post" class="position-relative">
        ...
        <section>
          <div class="content-wrapper">
            ...
            <p>
              Welcome to installation process! Just fill in the required
            ...
            <div class="form-check mt-5">
              ...
              <label class="form-check-label" for="license-checkbox">Yes, I am ready to install.</label>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="form-group col-12">
                <label for="purchase_code">Your License Code</label>
